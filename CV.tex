...
\usepackage[
  ...
  sorting=none,        % use citation order (not ydm)
  defernumbers=true,   % assign numeric labels when bibliographies are printed
  maxbibnames=20       % show up to 20 authors before truncating with et al.
]{biblatex}
\addbibresource{bib.bib}
% Force bibliography order to follow the order of entries in bib.bib by
% citing everything up front in that order.
\nocite{Vaswani:2026twx,Gamboa:2026jht,Barack:2026izc,Long:2025tvk,Whittall:2025dqn,Mendes:2025gov,Long:2025nmj,Scheel:2025jct,Abac:2025saz,Long:2024ltn,Barack:2023oqp,DaSilva:2023xif,LISA:2023arg,Boschini:2023ryi,Barack:2022pde,Long:2021ufh}
...
\begin{center}
\huge
\href{mailto:oliver.long@ucd.ie}{\faIcon{envelope}} \:
...
\textbf{Government of Ireland Postdoctoral Fellow}, University College Dublin \hfill Sep 2026 -- \\

\textbf{Postdoctoral Researcher}, Max Planck Institute for Gravitational Physics \hfill Nov 2022 -- Aug 2026\\
\vspace{-5mm}
\begin{itemize}
\item Used numerical data to perform resummations of weak-field expressions for the radiated energy \cite{Barack:2026izc} and scattering angle \cite{Long:2024ltn} of a point-particle source, extending their validity into the strong-field regime.
\item Extended the Spectral Einstein Code (\href{https://www.black-holes.org/for-researchers/spec}{\texttt{SpEC}}) to be capable of producing the most accurate simulations of hyperbolic binary black hole encounters to date~\cite{Long:2025nmj,Mendes:2025gov}, some of which have been made publically available~\cite{Scheel:2025jct}
\item Produced the first numerical relativity simulations of highly asymmetric mass-ratio hyperbolic binary black hole encounters (mass ratio 1:10) and performed the first measurements of disparate scattering angles due to asymmetric gravitational wave emission~\cite{Long:2025nmj}.
\item Used numerical relativity scattering simulations to extract high-order self-force coefficients and cross-validate post-Minkowskian calculations and effective-one-body models~\cite{Long:2025nmj,Long:2025tvk}.
\end{itemize}
...
\textbf{Ph.D.\ Student}, University of Southampton \hfill Sep 2018 -- Apr 2022\\ 
\vspace{-5mm}
\begin{itemize}
...
\item Derived analytic formulae for scattering geodesics in a black hole spacetime \cite{Long:2021ufh} and implemented them in the KerrGeodesics package of the \href{https://bhptoolkit.org/}{Black Hole Perturbation Toolkit}.
\end{itemize}
...
{\color{Sectioncolour}
\section*{Fellowships and grants {\rm (total: $\sim$\euro{1.02m})}}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}


\textbf{Ambizione Grant}, Swiss National Science Foundation. \textbf{CHF 632k} \hfill 2026 \\
\vspace{-5mm} 
\begin{itemize}
\item Funding for a four year tenure at Universität Zürich, Switzerland.
\end{itemize}
\textbf{Government of Ireland Postdoctoral Fellowship}, Research Ireland. \textbf{\euro{135k}} \hfill 2026 \\
\vspace{-5mm} 
\begin{itemize}
\item Funding for a two year tenure at University College Dublin, Ireland.
% \item Won as part of the Government of Ireland Postdoctoral Fellowship Programme 2025.
\end{itemize}
\textbf{Junior Investigator Fellowship}, Fundação para a Ciência e a Tecnologia. $\sim$\textbf{\euro{130k}} \hfill 2025 \\
\vspace{-5mm} 
\begin{itemize}
\item Funding for a three year tenure at the Instituto Superior Técnico, Portugal.
% \item Won as part of the 7th Call for the Stimulus of Scientific Employment, Individual Support (CEECIND).
\end{itemize}
\newpage
\textbf{Doctoral Prize Fellowship}, Engineering and Physical Sciences Research Council. $\sim$\textbf{£40k} \hfill 2022 \\
\vspace{-5mm}
\begin{itemize}
\item Funding for a one year tenure at the University of Southampton, United Kingdom.
...
\vspace{-5mm}
\printbibliography[keyword={feature},title={~}]
...
\vspace{-5mm}
\printbibliography[notkeyword={feature},title={~}]
...
%----------------------------------------------------------------------------------------
  ...
  {\color{Sectioncolour}
\section*{Invited seminars {\rm (total: 4)}}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item CENTRA Seminar, Instituto Superior Técnico, ``Black hole scattering with numerical methods and the resummation of weak-field analytic expressions", 30th April 2026.
\item WQFT Seminar, Humboldt University of Berlin, ``Black hole scattering in the strong-field regime: Merging post-Minkowskian theory with numerical methods", 25th November 2024.
...
\end{itemize}
  ...
  {\color{Sectioncolour}
\section*{Invited talks {\rm (total: 12)}}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item Amplitudes, Strong-Field Gravity and Resummation, The Nordic Institute for Theoretical Physics, ``Black hole scattering in the strong-field regime: Merging post-Minkowskian theory with numerical methods", 15th April 2026.
\item Milestones in Amplitudes for Gravitational Waves and Cosmology, ETH Zürich, ``Black hole scattering in the strong-field regime: Merging post-Minkowskian theory with numerical methods", 25th March 2026.
\item Hyperboloidal Foliations and their Application, Erwin Schrödinger Institute, Universität Wien, ``Hyping up self-force scattering: Methods and applications in the pre-hyperboloidal era", 13th January 2026.
\item GWSky kick-off meeting, Max Planck Institute for Gravitational Physics, ``NR, PM, PN, GSF comparisons and transferring information from one method to another", 9th December 2025 (joint with Raj Patil).
...
\end{itemize} 
 ...
 {\color{Sectioncolour}
\section*{Contributed talks {\rm (total: 15)}}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item 29th Capra Meeting on Radiation Reaction in General Relativity, Université Libre de Bruxelles, ``Resummed radiative observables in eccentric and unbound extreme-mass-ratio systems using critical orbits", 2nd July 2026.
...
\item LISA Symposium XIV, ``Self-force in hyperbolic black hole encounters", 25th -- 29th July 2022. \href{https://www.youtube.com/watch?v=p2-RgYB6Jhk}{\faIcon{link}}
\item 23rd International Conference on General Relativity and Gravitation, Chinese Academy of Science via Zoom, ``Self-force in hyperbolic black hole encounters", 5th July 2022. \href{https://www.koushare.com/video/videodetail/30159}{\faIcon{link}}
\item 25th Capra Meeting on Radiation Reaction in General Relativity, University College Dublin, ``Self-force in hyperbolic black hole encounters", 22nd June 2022. \href{https://oliverlong.info/talks/capra25}{\faIcon{link}}
\item BritGrav22, University of Glasgow via Zoom, ``Self-force in hyperbolic binary-black-hole encounters", \\ 4th April 2022. \href{https://www.youtube.com/watch?v=zZEblkjb5IM}{\faIcon{link}}
\item 24th Capra Meeting on Radiation Reaction in General Relativity, Perimeter Institute via Zoom, ``Time-domain metric reconstruction for hyperbolic scattering", 10th June 2021. \href{https://pirsa.org/21060058}{\faIcon{link}}
\item BritGrav21, University College Dublin via Zoom, ``Towards a self-force calculation of the scatter angle in hyperbolic encounters", 13th April 2021. \href{https://oliverlong.info/talks/britgrav21}{\faIcon{link}}
\item LISA Symposium XIII, ``Towards a self-force calculation of the scatter angle in hyperbolic encounters", 1st -- 3rd October 2020. \href{https://lisasymposium13.lisamission.org/presentations/i0xMnRFWi7WKbO5f01caGDH0zPK2/7qz7uYC3qHuzj9AsC49h}{\faIcon{link}}
\item 23rd Capra Meeting on Radiation Reaction in General Relativity, University of Texas at Austin via Zoom, ``Towards a self-force calculation of the scatter angle in hyperbolic encounters", 24th June 2020. \href{https://www.youtube.com/watch?v=HB-Rw5kRUfg&t=11311s}{\faIcon{link}}
\end{itemize} 
...
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item Precision Gravitational Wave Astronomy: From Theory to Discovery, Sexten Center for Astrophysics, 27th -- 31st July 2026.
...
Francesco Grippa \hfill Nov 2025 -- Apr 2026\\ \vspace{-5mm}
\begin{itemize}
\item Visiting PhD student from Salerno University, co-supervised with Harald Pfeiffer.
\item Project: Initial data for hyperbolic black hole encounters using the Extended Conformal Thin Sandwich (XCTS) approach.
\end{itemize} 

 {\color{Sectioncolour}
\section*{Panels and discussions}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item Panel member for ``Connections to other approaches (EOB/NR/Amplitudes/PN) and Merger/Ringdown'', 29th Capra Meeting on Radiation Reaction in General Relativity, Université Libre de Bruxelles, 3rd July 2026.
...
{\bf Multiscale Self-Force (M2SF) Collaboration}  \hfill Sep 2026 -- \\
\vspace{-5mm}
\begin{itemize}
...
\vspace{-5mm}
\begin{itemize}
\item Contributor to the Spectral Einstein Code (\texttt{SpEC}) and the \texttt{scri} package.
...
\end{itemize}
{\bf Laser Interferometer Space Antenna (LISA) Consortium}  \hfill Oct 2018 -- \\
\vspace{-5mm}
\begin{itemize}
\item Lead of the EMRI subproject of the Waveform Parameter Space for Astrophysical Sources project.
\item Member of the Waveform Working Group and LISA Early Career Scientists (LECS).
\end{itemize} 
{\bf LIGO Scientific Collaboration}  \hfill Apr 2023 -- Nov 2023 \\
\vspace{-5mm}
\begin{itemize}
...
\item Reviewer for {\em Physical Review Letters},  {\em Physical Review D}, and {\em SciPost Physics}.  \hfill Mar 2023 --\\ \vspace{-5mm}
\end{itemize} 
...
\item Extensive experience with running and troubleshooting binary black hole simulations with \texttt{SpEC}.
\end{itemize}
...
% \begin{itemize}
% \item Prof.\ Leor Barack; PhD supervisor; University of Southampton; \href{mailto:L.Barack@soton.ac.uk}{L.Barack@soton.ac.uk}.
% \item Prof.\ Harald Pfeiffer; Postdoctoral advisor; MPI for Gravitational Physics; \href{mailto:harald.pfeiffer@aei.mpg.de}{Harald.Pfeiffer@aei.mpg.de}.
