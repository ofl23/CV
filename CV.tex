...
\textbf{Government of Ireland Postdoctoral Fellowship}, Research Ireland. \hfill 2026 \\
\vspace{-5mm} 
\begin{itemize}
\item Funding for a two year tenure within the Relativity Group at University College Dublin (UCD), Ireland.
\item Won as part of the Government of Ireland Postdoctoral Fellowship Programme 2025.
\end{itemize}
\textbf{Junior Investigator Fellowship}, Fundação para a Ciência e a Tecnologia (FCT). \hfill 2025 \\
\vspace{-5mm} 
\begin{itemize}
\item Funding for a three year tenure at the Center for Astrophysics and Gravitation (CENTRA) within the Instituto Superior Técnico (IST), Portugal.
\item Won as part of the 7th Call for the Stimulus of Scientific Employment, Individual Support (CEECIND).
\end{itemize}
\textbf{Seal of Excellence}, European Commission Horizon Europe. \hfill 2025 \& 2026 \\
\vspace{-5mm} 
\begin{itemize}
\item Gravitational Waves from Hyperbolic Encounters (GWHypE) is recognised as a highly rated proposal for the Marie Skłodowska-Curie Actions Postdoctoral Fellowships 2024 (86\%) and 2025 (96\%).
\end{itemize}
\textbf{Doctoral Prize Fellowship}, Engineering and Physical Sciences Research Council (EPSRC). \hfill 2022 \\
\vspace{-5mm}
\begin{itemize}
