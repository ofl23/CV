...
\item Extended the Spectral Einstein Code (\href{https://www.black-holes.org/for-researchers/spec}{\textsc{SpEC}}) to be capable of producing the most accurate simulations of hyperbolic binary black hole encounters to date~\cite{Long:2025nmj,Mendes:2025gov}, some of which have been made publically available~\cite{Scheel:2025jct}
