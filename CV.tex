...
\item Extended the Spectral Einstein Code (\texttt{SpEC}) to be capable of accurately and efficiently calculating hyperbolic binary black hole encounters \cite{NR:Prep}.
...
{\color{Sectioncolour} 
\section*{Articles in preparation {\rm (total: 3)}}
\vspace{-3mm}
\noindent\rule{\linewidth}{0.6pt}}
