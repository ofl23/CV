...
\item Extended the Spectral Einstein Code (SpEC) to be capable of accurately and efficiently calculating hyperbolic binary black hole encounters.
%\item Extended the pySEOBNR code to be able to calculate hyperbolic binary black hole encounters \cite{NREOB:prep}.
\end{itemize}
...
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item WQFT Seminar, Humboldt University, 18th November 2024 (Scheduled).
\item Gravity Seminar, University of Southampton, 7th November 2024 (Scheduled).
\item Amplitudes and Gravity Seminar, Institut des Hautes Études Scientifiques and Institut de Physique Théorique, 16th October 2024 (Scheduled).
...
\noindent\rule{\linewidth}{0.6pt}}
\begin{itemize}
\item ``Hyperbolic Binary Black Hole encounters with SpEC" Simulating Extreme Spacetimes with SpEC and SpECTRE, The Institute for Computational and Experimental Research in Mathematics, Brown University, 7th August 2024.
...
\item ``Comparison of post-Minkowskian and self-force expansions: Scattering in a scalar charge toy model" 26th Capra Meeting on Radiation Reaction in General Relativity, Niels Bohr Institute, 4tth July 2023.
...
\end{itemize} 
{\bf Capra community}  \hfill Oct 2018 -- \\
\vspace{-5mm}
\begin{itemize}
\item Member of the Equality, Diversity and Inclusion (EDI) Team.
\end{itemize} 
