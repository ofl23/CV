...
\textbf{Postdoctoral Researcher}, Max Planck Institute for Gravitational Physics (Potsdam) \hfill Nov 2022 --\\ \vspace{-5mm}
\begin{itemize}
...
\item Extended the Spectral Einstein Code (SpEC) to be capable of handling more extreme parameters leading to the first known Numerical Relativity calculations of hyperbolic encounters between two black holes of unequal mass \cite{NREOB:prep}.
