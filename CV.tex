...
\item Produced the first numerical relaitivty simulations of highly asymmetric mass-ratio hyperbolic binary black hole encounters (mass ratio 1:10) and performed the first measurements of disparate scattering angles due to asymmetric gravitational wave emission~\cite{Long:2025nmj}.
\item Used numerical relativity scattering simulations to extract high-order self-force coefficients and cross-validate post-Minkowksian calculations and effective-one-body models~\cite{Long:2025nmj,Long:2025tvk}.
\end{itemize}
